...
import lando.systems.ld51.utils.typinglabel.TypingLabel;
...
public class CreditScreen extends BaseScreen {
    ...
    private final String theme = "Made for Ludum Dare 51: Every 10 Seconds";
    ...
    public void render(float delta) {
        ...
        batch.begin();
        {
            ...
            batch.draw(game.assets.pixelRegion, 25f, 130f, Config.Screen.window_width / 2f - 50f, 300f);
            batch.draw(game.assets.pixelRegion, Config.Screen.window_width / 2f + 25f, 130f, Config.Screen.window_width / 2f - 50f, 300f);
